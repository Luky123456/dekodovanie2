...
obr = Image.open("obrsospr.png")
obr2 = Image.open("obrsospr2.png")
pixels = obr.load()
pixels2 = obr2.load()
farba = []
farba2=[]
...
def oddrticka(obr,obr2):
    ...
    print(*konecec)
    #výsledok treba dať to online binary to string prekladača lebo som nepochopil ako premeniť binary na string v pythone
